  ...
  <main>
    ...
    <div class="container">
      ...
      <section id="about" class="about mt-4 mb-3">
        ...
        <!--Secion heading-->
        <h2 class="text-center mb-5 my-5 py-4 dark-grey-text font-weight-bold wow fadeIn" data-wow-delay="0.2s"> about </h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 ml-lg-auto col-md-12 wow fadeIn" data-wow-delay="0.4s">
            ...
            <!--Title-->
            <h4 class="grey-text-2 mb-4">شفط الدهون و شد ترهلات البطن بعد الولادة</h4>
            <!--Description-->
           
            <a href="../Landing-Page-Medical.php" class="btn btn-rounded btn-purple-2 purple-text wow fadeIn" data-wow-delay="0.2s"><i
...
<div class="col-lg-6 ml-lg-auto col-md-12 wow fadeIn" data-wow-delay="0.4s">
  ...
  <!--Title-->
  <h4 class="grey-text-2 mb-4">تكبير و تصغير الثدي</h4>
...
<div class="col-lg-6 ml-lg-auto col-md-12 wow fadeIn" data-wow-delay="0.4s">
  ...
  <!--Title-->
  <h4 class="grey-text-2 mb-4">شد الجفون وإزالة الترهلات</h4>
...
<div class="col-lg-6 ml-lg-auto col-md-12 wow fadeIn" data-wow-delay="0.4s">
  ...
  <!--Title-->
  <h4 class="grey-text-2 mb-4">شد الوجه </h4>
...
<div class="col-lg-6 ml-lg-auto col-md-12 wow fadeIn" data-wow-delay="0.4s">
  ...
  <!--Title-->
  <h4 class="grey-text-2 mb-4"> علاج الحروق الجديدة والقديمة</h4>
...
<div class="col-lg-6 ml-lg-auto col-md-12 wow fadeIn" data-wow-delay="0.4s">
  ...
  <!--Title-->
  <h4 class="grey-text-2 mb-4">حقن الميزوثيرابي والفيللر </h4>
...
<div class="container mt-5 mb-4 text-center text-md-left">
  <div class="row mt-3">
    ...
    <div class="col-md-4 col-lg-3 col-xl-3">
      ...
      <p>
        <i class="fas fa-envelope mr-3"></i> hamsam295@gmail.com</p>
      <p>
