<!-- Navigation -->
    ...
    <!-- Intro Section -->
    <div class="view jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url(https://mdbootstrap.com/img/Photos/Others/model-2.jpg); background-repeat: no-repeat; background-size: cover; background-position: center center;">
...
if (isset($_POST['login'])) 
{
  ...
  $login ="SELECT name,ID_user,E_mail,PASSWORD FROM users where E_mail='$mail' AND PASSWORD='$pass'";
